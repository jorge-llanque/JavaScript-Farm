...
let videoGames = ['Mario 3', 'Call of Duty', 'Star Wars', 'DBS'];
...
let weather = ['hot', 'cold', 'rain', 'freeze'];
weather.shift();
console.log(weather); // => ['cold', 'rain', 'freeze']
...
let occupation = ['engineer', 'singer', 'musician', 'layer', 'flight attendant', 'pilot', 'doctor'];
console.log(occupation.join()); // => engineer,singer,musician,layer,flight attendant,pilot,doctor
console.log(occupation.join('-')); // => engineer-singer-musician-layer-flight attendant-pilot-doctor
console.log(occupation.join(', ')); // => engineer, singer, musician, layer, flight attendant, pilot, doctor
