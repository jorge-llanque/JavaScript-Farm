...
let wordsMinorToSix = business.filter(
  (currentValue) => currentValue.length < 6
);
...
let findIndexOfLengthIsGreaterThan7 = subject.findIndex(
...
let phrase3 =
  "hot music is now a new hot station and its director is Carlyn hot";
